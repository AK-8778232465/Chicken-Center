                ...
                <div class="product-carousel">
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item" style="border: 0px;">
                            <div class="thumb" style="border-top-left-radius: 20px;border-top-right-radius: 20px;">
                                <div class="photo" style="background-image:url(assets/uploads/<?php echo $row['p_featured_photo']; ?>);"></div>
                                <a class="overlay" href="product.php?id=<?php echo $row['p_id']; ?>"></a>
                            </div>
                            <div class="text" style="min-height: 100px;background-color: #ffdea3;border-bottom-left-radius: 20px;border-bottom-right-radius: 20px;">
