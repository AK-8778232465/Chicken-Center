...
<head>
	...
	foreach ($result as $row) {
		...
		$returnPolicy_meta_title = $row['about_meta_title'];
		$returnPolicy_meta_keyword = $row['about_meta_keyword'];
		$returnPolicy_meta_description = $row['about_meta_description'];
	...
	if($cur_page == 'Return-Policy.php') {
		?>
		<title><?php echo $returnPolicy_meta_title; ?></title>
		<meta name="keywords" content="<?php echo $returnPolicy_meta_keyword; ?>">
		<meta name="description" content="<?php echo $returnPolicy_meta_description; ?>">
		<?php
	}
	if($cur_page == 'Privacy-Policy.php') {
		?>
		<title><?php echo $PrivacyPolicy_meta_title; ?></title>
		<meta name="keywords" content="<?php echo $PrivacyPolicy_meta_keyword; ?>">
		<meta name="description" content="<?php echo $PrivacyPolicy_meta_description; ?>">
		<?php
	}
	if($cur_page == 'Shiping-Policy.php') {
		?>
		<title><?php echo $shipingPolicy_meta_title; ?></title>
		<meta name="keywords" content="<?php echo $shipingPolicy_meta_keyword; ?>">
		<meta name="description" content="<?php echo $shipingPolicy_meta_description; ?>">
		<?php
	}
	if($cur_page == 'Terms_and_Conditions.php') {
		?>
		<title><?php echo $termsAndCondition_meta_title; ?></title>
		<meta name="keywords" content="<?php echo $termsAndCondition_meta_keyword; ?>">
		<meta name="description" content="<?php echo $termsAndCondition_meta_description; ?>">
		<?php
	}
	if($cur_page == 'faq.php') {
		?>
				...
				<div class="menu-container">
					<div class="menu">
						<ul>
							...
							<li><a href="Shiping-Policy.php"><?php echo $shipingPolicy_title; ?></a></li>
							<li><a href="Terms_and_Conditions.php"><?php echo $termsAndCondition_title; ?></a></li>
							<li><a href="Return-Policy.php"><?php echo $returnPolicy_title; ?></a></li>
							<li><a href="Privacy-Policy.php"><?php echo $PrivacyPolicy_title; ?></a></li>
